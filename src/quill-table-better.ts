  ...
  return {
    ...
    handler(range: Range, context: Context) {
      ...
      const cellId = getCellId(
        line.parent.formats()[line.parent.statics.blotName]
      );
      line.replaceWith(TableCellBlock.blotName, cellId);
    },
  };
...
// Export formats for direct access
export {
  cellId,
  TableCellBlock,
  TableThBlock,
...
export { default as TableHeader } from "./formats/header";
export { ListContainer, default as TableList } from "./formats/list";
